...
void LCD_Initialization (void)
{
    ...
    GPIO_SetPinDirection(3u , 4u , 0u);
    GPIO_SetPinDirection(3u , 5u , 0u);
    GPIO_SetPinDirection(3u , 6u , 0u);
    GPIO_SetPinDirection(3u , 7u , 0u);

    GPIO_SetPinDirection(4u , 2u , 0u);
    GPIO_SetPinDirection(4u , 0u , 0u);
    GPIO_SetPinDirection(4u , 1u , 0u);
    ...
    GPIO_WriteOnPin(4u , 2u , 0u);
    GPIO_WriteOnPin(4u , 0u , 0u);
    GPIO_WriteOnPin(4u , 1u , 1u);
    GPIO_WriteOnPort(3u , 0x28);
    GPIO_WriteOnPin(4u , 1u , 0u);
...
void LCD_SendCommand(uint8 a_u8command)
{
    ...
    GPIO_WriteOnPin(4u , 0u , 0u);
    GPIO_WriteOnPin(4u , 1u , 1u);
    GPIO_WriteOnPort(3u , a_u8command);
    GPIO_WriteOnPin(4u , 1u , 0u);
 _delay((unsigned long)((5)*(8000000/4000000.0)));
    GPIO_WriteOnPin(4u , 1u , 1u);
 _delay((unsigned long)((10)*(8000000/4000000.0)));
    ...
    GPIO_WriteOnPin(4u , 0u , 0u);
    GPIO_WriteOnPin(4u , 1u , 1u);
    GPIO_WriteOnPort(3u , a_u8command << 4);
    GPIO_WriteOnPin(4u , 1u , 0u);
 _delay((unsigned long)((5)*(8000000/4000000.0)));
    GPIO_WriteOnPin(4u , 1u , 1u);
 _delay((unsigned long)((10)*(8000000/4000000.0)));
...
# 148 "LCD.c"
    ...
    GPIO_WriteOnPin(4u , 2u , 1u);
    GPIO_WriteOnPin(4u , 0u , 0u);
    GPIO_WriteOnPin(4u , 1u , 1u);
    GPIO_WriteOnPort(3u , a_u8data);
    GPIO_WriteOnPin(4u , 1u , 0u);
 _delay((unsigned long)((5)*(8000000/4000000.0)));
    GPIO_WriteOnPin(4u , 1u , 1u);
 _delay((unsigned long)((10)*(8000000/4000000.0)));
    ...
    GPIO_WriteOnPin(4u , 0u , 0u);
    GPIO_WriteOnPin(4u , 1u , 1u);
    GPIO_WriteOnPort(3u , a_u8data << 4);
    GPIO_WriteOnPin(4u , 1u , 0u);
 _delay((unsigned long)((5)*(8000000/4000000.0)));
    GPIO_WriteOnPin(4u , 1u , 1u);
 _delay((unsigned long)((10)*(8000000/4000000.0)));
...
void LCD_SetDisplayPosition(uint8 a_u8position_X , uint8 a_u8position_Y)
{
 ...
 if((a_u8position_X >= 0)&&(a_u8position_X < 16))
 {
  ...
  {
  case 1:
   LCD_SendCommand(a_u8position_X + 0x80);

            g_u8position = a_u8position_X;
   break;
  case 2:
   LCD_SendCommand(a_u8position_X + 0xC0);
  ...
  case 3:
   LCD_SendCommand(a_u8position_X + 0x90);

            g_u8position = 32 + a_u8position_X;
   break;
  case 4:
   LCD_SendCommand(a_u8position_X + 0xD0);
 ...
 if(a_s32number<0)
 {
  ...
  LCD_SendDataByte('-');
    ...
    while(DigitNo != 0)
    {
        ...
        LCD_SendDataByte(((a_s32number / div) + 0x30));
