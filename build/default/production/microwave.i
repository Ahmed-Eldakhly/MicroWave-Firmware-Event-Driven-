...
static uint8 g_u8timer_arr[6] = {48u , 48u , ':' , 48u , 48u , '\0'};
...
void Display_remind_time (void)
{
    ...
    if(g_u8heating_finished_flag == 1)
    {
        ...
        LCD_SendDataByte((g_u16MicrowaveTime / 600) + 48u);
        LCD_SendDataByte(((g_u16MicrowaveTime / 60) % 10) + 48u);
        LCD_SendDataByte(':');
        LCD_SendDataByte(((g_u16MicrowaveTime % 60) / 10) + 48u);
        LCD_SendDataByte(((g_u16MicrowaveTime % 60) % 10) + 48u);
    }
...
void Door_sensor_function(void)
{
    ...
    if(GPIO_ReadFromPin(1u , 4u) == 0u)
    {
        ...
        while(GPIO_ReadFromPin(1u , 4u) == 0u);
...
void Weight_sensor_function(void)
{
    ...
    if(g_door_state_t == DOOR_IS_OPENED && GPIO_ReadFromPin(1u , 5u) == 0u)
    {
        ...
        while(GPIO_ReadFromPin(1u , 5u) == 0u);
    ...
    if(g_u8keypad_button_val >= 0 && g_u8keypad_button_val < 10)
    {
        ...
        switch(g_u8time_digits)
        {
            case 0:
                ...
                g_u8timer_arr[4] = g_u8keypad_button_val + 48u;
            ...
            case 2:
                ...
                g_u16MicrowaveTime = (g_u8timer_arr[1] - 48u) * 60 +
                        (g_u8timer_arr[3] - 48u) * 10 + g_u8keypad_button_val;
                break;
            case 3:
                ...
                if(!(g_u8timer_arr[1] == 57 && g_u8timer_arr[3] == 57 && g_u8timer_arr[4] >= 54 ))
                {
                    ...
                    g_u16MicrowaveTime = (g_u8timer_arr[0] - 48u) * 600 +
                            (g_u8timer_arr[1] - 48u) * 60 +
                            (g_u8timer_arr[3] - 48u) * 10 + g_u8keypad_button_val;
                }
                else
                {
...
void Welcome_screen_display(void)
{
    ...
    _delay((unsigned long)((2000)*(8000000u/4000.0)));
}
# 609 "microwave.c"
