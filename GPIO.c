 ...
 * Outputs:			NULL
 *
 * Return:			Status to check function execution correctly (EnumGPIO_Status_t)
 *******************************************************************************/
    ...
    switch(a_u8port)
    {
        ...
        case GPIO_PORTE:
            ...
            if(a_u8pin < GPIO_PIN4)
            {
                ...
                else if(a_u8direction == OUTPUT && a_u8pin != GPIO_PIN3)
                {
    ...
    switch(a_u8port)
    {
        case GPIO_PORTA:
            ...
            if(a_u8pin <= GPIO_PIN7)
            {
                if(a_u8value == HIGH)
                {
                    SET_BIT(GPIO_WRITE_VALUE_PORTA,a_u8pin);
                    retVal = GPIO_CORRECT_SET;
                }
                else if(a_u8value == LOW)
                {
                    CLEAR_BIT(GPIO_WRITE_VALUE_PORTA,a_u8pin);
                    retVal = GPIO_CORRECT_SET;
                }
                else
                {
        ...
        case GPIO_PORTB:
            ...
            if(a_u8pin <= GPIO_PIN7)
            {
                if(a_u8value == HIGH)
                {
                    SET_BIT(GPIO_WRITE_VALUE_PORTB,a_u8pin);
                    retVal = GPIO_CORRECT_SET;
                }
                else if(a_u8value == LOW)
                {
                    CLEAR_BIT(GPIO_WRITE_VALUE_PORTB,a_u8pin);
                    retVal = GPIO_CORRECT_SET;
                }
                else
                {
        ...
        case GPIO_PORTC:
            ...
            if(a_u8pin <= GPIO_PIN7)
            {
                if(a_u8value == HIGH)
                {
                    SET_BIT(GPIO_WRITE_VALUE_PORTC,a_u8pin);
                    retVal = GPIO_CORRECT_SET;
                }
                else if(a_u8value == LOW)
                {
                    CLEAR_BIT(GPIO_WRITE_VALUE_PORTC,a_u8pin);
                    retVal = GPIO_CORRECT_SET;
                }
                else
                {
        ...
        case GPIO_PORTD:
            ...
            if(a_u8pin <= GPIO_PIN7)
            {
                if(a_u8value == HIGH)
                {
                    SET_BIT(GPIO_WRITE_VALUE_PORTD,a_u8pin);
                    retVal = GPIO_CORRECT_SET;
                }
                else if(a_u8value == LOW)
                {
                    CLEAR_BIT(GPIO_WRITE_VALUE_PORTD,a_u8pin);
                    retVal = GPIO_CORRECT_SET;
                }
                else
                {
        ...
        case GPIO_PORTE:
            ...
            if(a_u8pin < GPIO_PIN3)
            {
                if(a_u8value == HIGH)
                {
                    SET_BIT(GPIO_WRITE_VALUE_PORTE,a_u8pin);
                    retVal = GPIO_CORRECT_SET;
                }
                else if(a_u8value == LOW)
                {
                    CLEAR_BIT(GPIO_WRITE_VALUE_PORTE,a_u8pin);
                    retVal = GPIO_CORRECT_SET;
                }
                else
                {
...
EnumGPIO_Status_t GPIO_WriteOnPort(uint8 a_u8port , uint8 a_u8value)
{
    ...
    {
        case GPIO_PORTA:
            GPIO_WRITE_VALUE_PORTA &= 0x00;
            GPIO_WRITE_VALUE_PORTA |= a_u8value;
            break;
        case GPIO_PORTB:
            GPIO_WRITE_VALUE_PORTB &= 0x00;
            GPIO_WRITE_VALUE_PORTB |= a_u8value;
            break;
        case GPIO_PORTC:
            GPIO_WRITE_VALUE_PORTC &= 0x00;
            GPIO_WRITE_VALUE_PORTC |= a_u8value;
            break;
        case GPIO_PORTD:
            GPIO_WRITE_VALUE_PORTD &= 0x00;
            GPIO_WRITE_VALUE_PORTD |= a_u8value;
            break;
        case GPIO_PORTE:
            GPIO_WRITE_VALUE_PORTE &= 0xF8;
            GPIO_WRITE_VALUE_PORTE |= (a_u8value & 0x07);
            break;
        default:
            /* inserted port doesn't met the limits on ports in this micro_controller */
            retVal = GPIO_UNCORRECT_SET;
...
uint8 GPIO_ReadFromPin(uint8 a_u8port , uint8 a_u8pin)
{
    ...
    {
        case GPIO_PORTA:
            retVal = GET_BIT(GPIO_READ_VALUE_PORTA,a_u8pin);
            break;
        case GPIO_PORTB:
            retVal = GET_BIT(GPIO_READ_VALUE_PORTB,a_u8pin);
            break;
        case GPIO_PORTC:
            retVal = GET_BIT(GPIO_READ_VALUE_PORTC,a_u8pin);
            break;
        case GPIO_PORTD:
            retVal = GET_BIT(GPIO_READ_VALUE_PORTD,a_u8pin);
            break;
        case GPIO_PORTE:
            retVal = GET_BIT(GPIO_READ_VALUE_PORTE,a_u8pin);
            break;
        default:
            /*Do Nothing*/;
            break;
...
uint8 GPIO_ReadFromPort(uint8 a_u8port)
{
    ...
    {
        case GPIO_PORTA:
            retVal = GET_REG(GPIO_READ_VALUE_PORTA);
            break;
        case GPIO_PORTB:
            retVal = GET_REG(GPIO_READ_VALUE_PORTB);
            break;
        case GPIO_PORTC:
            retVal = GET_REG(GPIO_READ_VALUE_PORTC);
            break;
        case GPIO_PORTD:
            retVal = GET_REG(GPIO_READ_VALUE_PORTD);
            break;
        case GPIO_PORTE:
            retVal = GET_REG(GPIO_READ_VALUE_PORTE);
            break;
        default:
            /*Do Nothing*/;
            break;
...
EnumGPIO_Status_t GPIO_TogglePin(uint8 a_u8port , uint8 a_u8pin)
{
    ...
    switch(a_u8port)
    {
        case GPIO_PORTA:
            ...
            if(a_u8pin <= GPIO_PIN7)
            {
                TOGGLE_BIT(GPIO_WRITE_VALUE_PORTA,a_u8pin);
                retVal = GPIO_CORRECT_SET;
            }
            else
            {
        ...
        case GPIO_PORTB:
            ...
            if(a_u8pin <= GPIO_PIN7)
            {
                TOGGLE_BIT(GPIO_WRITE_VALUE_PORTB,a_u8pin);
                retVal = GPIO_CORRECT_SET;
            }
            else
            {
        ...
        case GPIO_PORTC:
            ...
            if(a_u8pin <= GPIO_PIN7)
            {
                TOGGLE_BIT(GPIO_WRITE_VALUE_PORTC,a_u8pin);
                retVal = GPIO_CORRECT_SET;
            }
            else
            {
        ...
        case GPIO_PORTD:
            ...
            if(a_u8pin <= GPIO_PIN7)
            {
                TOGGLE_BIT(GPIO_WRITE_VALUE_PORTD,a_u8pin);
                retVal = GPIO_CORRECT_SET;
            }
            else
            {
        ...
        case GPIO_PORTE:
            ...
            if(a_u8pin < GPIO_PIN3)
            {
                TOGGLE_BIT(GPIO_WRITE_VALUE_PORTE,a_u8pin);
                retVal = GPIO_CORRECT_SET;
            }
            else
            {
...
EnumGPIO_Status_t GPIO_TogglePort(uint8 a_u8port)
{
    ...
    {
        case GPIO_PORTA:
            TOGGLE_REG(GPIO_WRITE_VALUE_PORTA);
            break;
        case GPIO_PORTB:
            TOGGLE_REG(GPIO_WRITE_VALUE_PORTB);
            break;
        case GPIO_PORTC:
            TOGGLE_REG(GPIO_WRITE_VALUE_PORTC);
            break;
        case GPIO_PORTD:
            TOGGLE_REG(GPIO_WRITE_VALUE_PORTD);
            break;
        case GPIO_PORTE:
            temp = (GPIO_WRITE_VALUE_PORTE>>3)<<3;
            TOGGLE_REG(GPIO_WRITE_VALUE_PORTE);
            GPIO_WRITE_VALUE_PORTE = ((GPIO_WRITE_VALUE_PORTE<<5)>>5) | temp;
            break;
        default:
            /* inserted port doesn't met the limits on ports in this micro_controller */
            retVal = GPIO_UNCORRECT_SET;
 ...
 *
 * Description: 	Disable ADC peripherals on selected pins from PortA, PortB and PortE.
 *
 * Inputs:			a_u8port          (uint8)
 *                  a_u8pin           (uint8)
 *
...
EnumGPIO_Status_t GPIO_Disable_ADC_On_Pins(uint8 a_u8port , uint8 a_u8pin)
{
    ...
    switch(a_u8port)
    {
        case GPIO_PORTA:
            ...
            {
                case GPIO_PIN0:
                    ADC_CONTROL_REGISTER_1 |= 0x0F;
                    retVal = GPIO_CORRECT_SET;
                    break;
                case GPIO_PIN1:
                    ADC_CONTROL_REGISTER_1 |= 0x0E;
                    retVal = GPIO_CORRECT_SET;
                    break;
                case GPIO_PIN2:
                    ADC_CONTROL_REGISTER_1 |= 0x0D;
                    retVal = GPIO_CORRECT_SET;
                    break;
                case GPIO_PIN3:
                    ADC_CONTROL_REGISTER_1 |= 0x0C;
                    retVal = GPIO_CORRECT_SET;
                    break;
                case GPIO_PIN5:
                    ADC_CONTROL_REGISTER_1 |= 0x0B;
                    retVal = GPIO_CORRECT_SET;
                    break;
                default:
                    /* inserted pin doesn't met the limits for ADC pins in this port */
                    retVal = GPIO_UNCORRECT_SET;
                    break;
            }
            break;
        case GPIO_PORTB:
            ...
            {
                case GPIO_PIN0:
                    ADC_CONTROL_REGISTER_1 |= 0x03;
                    retVal = GPIO_CORRECT_SET;
                    break;
                case GPIO_PIN1:
                    ADC_CONTROL_REGISTER_1 |= 0x05;
                    retVal = GPIO_CORRECT_SET;
                    break;
                case GPIO_PIN2:
                    ADC_CONTROL_REGISTER_1 |= 0x07;
                    retVal = GPIO_CORRECT_SET;
                    break;
                case GPIO_PIN3:
        ...
        case GPIO_PORTE:
            ...
            {
                case GPIO_PIN0:
                    ADC_CONTROL_REGISTER_1 |= 0x0A;
                    retVal = GPIO_CORRECT_SET;
                    break;
                case GPIO_PIN1:
                    ADC_CONTROL_REGISTER_1 |= 0x09;
                    retVal = GPIO_CORRECT_SET;
                    break;
                case GPIO_PIN2:
                    ADC_CONTROL_REGISTER_1 |= 0x08;
                    retVal = GPIO_CORRECT_SET;
                    break;
                default:
                    /* inserted pin doesn't met the limits for ADC pins in this port */
            ...
            break;
        default:
            /* inserted port doesn't met the limits on ADC ports in this micro_controller */
            retVal = GPIO_UNCORRECT_SET;
            break;
    }
    return retVal;
...
{
    CLEAR_BIT(INTERRUPT_CONTROL_REGISTER , ENABLE_PULL_UP_RESISTOR_ON_PORTB_BIT);
}
...
{
    SET_BIT(INTERRUPT_CONTROL_REGISTER , ENABLE_PULL_UP_RESISTOR_ON_PORTB_BIT);
}
